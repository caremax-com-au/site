...
namespace Amasty\PromoCountdown\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_promo_countdown_should_load_css';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_PromoCountdown::css/source/mkcss/amcountdown.css');
        }
