...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    /**
     * @var UpgradeSchema\OptimizeIndexTable
     */
    private $optimizeIndexTable;
    ...
    public function __construct(
        ...
        UpgradeSchema\OptimizeIndexTable $optimizeIndexTable
    ) {
        ...
        $this->optimizeIndexTable = $optimizeIndexTable;
    }
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.8.5', '<')) {
            $this->optimizeIndexTable->execute($setup);
        }
